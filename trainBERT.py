...
def main(args):
    ...
    model.from_pretrained(model_name="bert-base-cased")

    print("Training starting...")

    CACHED_FPATH = os.path.join("/scratch/ndekhil/cmdpred2/NRV/BERT/checkpoints/", f"epochs_{args.max_epochs}_batch_{args.batch_size}_lr_{args.lr}")
